...
from kusanagi.sdk.file import payload_to_file
from kusanagi.utils import MultiDict


def test_sdk_http_request():
    method = 'GET'
...
def test_sdk_http_request_query():
    method = 'GET'
    url = 'http://foo.com/bar/index/'
    request = HttpRequest(method, url)
...
def test_sdk_http_request_post():
    method = 'POST'
    url = 'http://foo.com/bar/index/'
    request = HttpRequest(method, url)
...
def test_sdk_http_request_headers():
    method = 'GET'
    url = 'http://foo.com/bar/index/'
    request = HttpRequest(method, url)
...
def test_sdk_http_request_body():
    method = 'POST'
    url = 'http://foo.com/bar/index/'
    request = HttpRequest(method, url)
...
def test_sdk_http_request_files():
    method = 'POST'
    url = 'http://foo.com/bar/index/'
    request = HttpRequest(method, url)
