...
def test_sdk_base_get_services(registry):
    api = base.Api(**{
        'component': None,
        'path': '/path/to/file.py',
        'name': 'dummy',
...
def test_sdk_base_get_service_schema(mocker):
    ...
    init = mocker.patch(
        'kusanagi.sdk.schema.service.ServiceSchema.__init__',
        return_value=None,
        )
...
def test_sdk_base_log(mocker, logs):
    SchemaRegistry()
