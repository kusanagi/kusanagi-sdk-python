...
from kusanagi.sdk.transport import TransactionTypeError
from kusanagi.sdk.transport import Transport
from kusanagi.payload import delete_path


def test_sdk_transport(read_json):
...
def test_sdk_transport_data(read_json):
    transport = Transport(read_json('transport.json'))
    payload = transport._Transport__transport
...
def test_sdk_transport_relations(read_json):
    transport = Transport(read_json('transport.json'))
    payload = transport._Transport__transport
...
def test_sdk_transport_links(read_json):
    transport = Transport(read_json('transport.json'))
    payload = transport._Transport__transport
...
def test_sdk_transport_calls(read_json):
    transport = Transport(read_json('transport.json'))
    payload = transport._Transport__transport
...
def test_sdk_transport_transactions(read_json):
    transport = Transport(read_json('transport.json'))
    payload = transport._Transport__transport
...
def test_sdk_transport_errors(read_json):
    transport = Transport(read_json('transport.json'))
    payload = transport._Transport__transport
